...
#define PORT_ERR_OK         0
#define PORT_ERR_NODEV      1		/* No such device */
#define PORT_ERR_TIMEDOUT   2/* Operation timed out */
#define PORT_ERR_UNKNOWN    3
...
int yapy_serial_read(void **port, void *buf, size_t nbyte);
int yapy_serial_write(void **port, void *buf, size_t nbyte);
int yapy_serial_gpio(void **port, int n, int level);
